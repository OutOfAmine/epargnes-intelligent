...
// I'll add the GitHub repo link under the main form
const newFooterStr = `      <div className="max-w-md w-full mx-auto bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 p-8 text-center shadow-xl shadow-zinc-200/50 dark:shadow-none transition-all duration-300 hover:shadow-2xl">`;

const repoFooterLink = `      <div className="max-w-md w-full mx-auto mt-8 mb-4 text-center">
        <a 
...
code = code.replace(newFooterStr, repoFooterLink);
